...
<head>
	...
	<title>سامانه فارغ التحصیلان - مدیریت پروژه ها</title>
	...
	<style type="text/css">
		...
		.box .box-title{margin-top:20px!important;}
	</style>
</head>
...
<!----------------------------------------------------Start Contents-------------------------------------------------->		
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-color box-bordered grey">
						<div class="box-title">
							<h3><i class="glyphicon-list"></i> پروژه ها</h3>
							<div class="actions">
...
<!--================================================================================================================--> 
	...
	<script src="grids_js/admin/manage_projects/grid_projects.js"></script>
