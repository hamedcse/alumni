			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-bordered box-color">
						<div class="box-title">
							<h3><i class="glyphicon-user"></i><span>پروفایل</span></h3>
							<div class="actions">
						...
						<!--Content Start-->
							<s:form theme="simple" action="updateProfile" id="frm_updateProfile" method="post" cssClass="form-horizontal form-column form-bordered">
								...
								<sj:div href="%{loadProfile}" id="loadProfileID" onSuccessTopics="successed_LoadProfiles"></sj:div>
								<div class="span12">
