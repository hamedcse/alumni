...
<%
	...
	//----NEW-SECURE-QUERY-----
	GridsDatabaseBridge dbBridge = new GridsDatabaseBridge("id, name, family, username, isActive, deleted "," project_manager ", passedParamsList, false, filters, doSearch);		/*CHANGE*/
