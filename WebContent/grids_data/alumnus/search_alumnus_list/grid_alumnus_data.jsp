...
<%
	...
	//----NEW-SECURE-QUERY-----
	GridsDatabaseBridge dbBridge1 = new GridsDatabaseBridge("id, username, name, family, yearOfGraduation, field, college, educationLevel "," alumnus ", passedParamsList, false, filters, doSearch);		/*CHANGE*/
	GridsDatabaseBridge dbBridge2 = new GridsDatabaseBridge("id, username, name, family, yearOfGraduation, field, college, educationLevel "," alumnus_archive ", passedParamsList, false, filters, doSearch);		/*CHANGE*/
