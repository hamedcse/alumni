$(function(){
  $("#grid_projects").jqGrid({
	url:'grids_data/admin/manage_projects/grid_projects_data.jsp',
	direction: 'rtl',
	datatype: "json",
	loadtext: 'بارگذاری...',
	autowidth: true,
	height:250,
    colNames:['آی دی','عنوان','موضوع','رشته','آی دی مدیر پروژه ','مشخصات مدیر پروژه ','تعلیق ','مشاهده جزئیات'],
    colModel :[
		...
		{name:'suspend', index:'suspend', align:'center', width:100,formatter:suspendFormatter, hidden:true},
   ...
   // rownumbers:true,
	...
	onCellSelect:function(rowid,iRow,iCol,e){
		...
		if(iRow == 7){
			var ret = $("#grid_projects").jqGrid('getRowData',rowid);
			window.location.href = "viewProjectDetail?pid="+ret.id;
		}
	}
	//-------------
