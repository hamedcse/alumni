$(function(){
  $("#grid_project_manager").jqGrid({
	url:'grids_data/admin/manage_users/grid_project_manager_data.jsp',
	direction: 'rtl',
	datatype: "json",
	loadtext: 'بارگذاری...',
	autowidth: true,
    colNames:['آی دی','نام','نام خانوادگی','نام کاربری','وضعیت','حذف شده','تعلیق مدیر','ویرایش '],
    colModel :[
    ...
    pager: '#pager_grid_project_manager',
    rowNum:2000,
    //rowList:[10,20,30],
	//shrinkToFit:true, 
    //viewrecords: true,
	...
	onCellSelect:function(rowid,iRow,iCol,e){
		...
		if(iRow == 8){
			//var ret = $("#grid_project_manager").jqGrid('getRowData',rowid);
			alert("here ...");
  ...
  $("#grid_project_manager").jqGrid('filterToolbar',{stringResult: true,searchOnEnter : false});
  $("#gbox_grid_project_manager").css("margin","0 auto");
});
