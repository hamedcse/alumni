$(function(){
  $("#grid_alumnus").jqGrid({
	url:'grids_data/common/search_alumnus_list/grid_alumnus_data.jsp',
	direction: 'rtl',
	datatype: "json",
	loadtext: 'بارگذاری...',
	autowidth: true,
	height:250,
    colNames:['آی دی','نام کاربری','نام','نام خانوادگی','سال فراغت از تحصیل','رشته تحصیلی','دانشکده','شهر','مقطع تحصیلی','مشاهده'],
    colModel :[
        ...
        {name:'city', index:'city', align:'center', width:60},
