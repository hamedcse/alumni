project_manager<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<div id="navigation">
			...
			<ul class="icon-nav">
				<li class="dropdown" style="font-family:tahoma!important;">
					...
					<ul class="dropdown-menu pull-right" style="min-width: 130px!important;">
						<li>
							<a href="project_manager_profile.jsp"><i class="glyphicon-user" style="margin-left: 5px;margin-top: -4px;"></i> مشاهده پروفایل</a>
						</li>
						<li>
