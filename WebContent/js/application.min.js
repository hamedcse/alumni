...
function hideNav() {
    ...
    $("#left").is(":visible") ? $("#main").css("margin-right", $("#left").width()) : $("#main").css("margin-right", 0);
    ...
    $("#left").hasClass("no-resize") || $("#left").resizable({
        ...
        resize: function (e, t) {
            ...
            if (Math.abs(200 - t.size.width) <= 20) {
                $("#left").css("width", 200);
                n.css("width", 145);
                r.css("margin-right", 200)
            } else r.css("margin-right", $("#left").width())
        },
        stop: function () {
