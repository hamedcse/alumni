	...
	<div id="main">
		<div class="container-fluid">
			<div class="page-header">
				<div class="pull-left"><h1>پنل مدیر پروژه</h1></div>
						...
						<div class="box-content">
							<ul class="tiles">
							 	<li class="lightred long">
									<a href="project_manager_projects.jsp" >
										<span><i class="glyphicon-show_thumbnails"></i></span>
										<span class="name"><i class="glyphicon-show_thumbnails"></i> پروژه های من</span>
									</a>
								</li>
							</ul>
						</div>
						...
						<div class="box-content">
							<ul class="tiles">
							 	<li class="satgreen long">
									<a href="project_manager_create_project.jsp" >
										<span class="count"><i class="glyphicon-folder_plus"></i> </span>
										<span class="name"><i class="glyphicon-folder_plus" style="margin-left:1px;"></i> پروژه جدید</span>
									</a>
								</li>
							</ul>
						</div>
