...
<head>
	...
	<title>سامانه فارغ التحصیلان  - پروفایل مدیر پروژه</title>
	...
	<script type="text/javascript">
		...
		$.subscribe('successed_loadProjectManagerProfile', function(event,element) {
			stopLoadingOverlay("loading_overlay");
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-bordered box-color">
						<div class="box-title">
							<h3><i class="glyphicon-user"></i><span>پروفایل مدیر پروژه</span></h3>
							<div class="actions">
						...
						<!--Content Start-->
							<s:form theme="simple" action="updateProfile" id="frm_updateProfile" method="post" cssClass="form-horizontal form-column form-bordered">
								<s:url id="loadProjectManagerProfile" value="/loadProjectManagerProfile.action"/>
								<sj:div href="%{loadProjectManagerProfile}" id="loadProjectManagerProfileID" onSuccessTopics="successed_loadProjectManagerProfile"></sj:div>
								<div class="span12">
