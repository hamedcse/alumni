...
<head>
	...
	<title>سامانه  فارغ التحصیلان  - بازیابی رمز عبور</title>
...
<body class='login theme-darkblue' data-theme="theme-darkblue">
	<div class="wrapper" style="margin-top: -160px;">
		<h1><a href="javascript:;">بازیابی رمز عبور</a></h1>
		<div class="login-body" style="padding-top:20px;">
			...
			<s:form theme="simple"  name="form_login" id="frm_login"  action="login" method="post" cssStyle="margin:0;padding-bottom:15px;">
				<div class="control-group">
					<div class="email controls">
						<label for="txt_username" style="margin-top: 4px;">نام کاربری خود را وارد کنید:</label>
						<br><br>
						<input type="text" style="direction:ltr;width:100%;" name='username' id="txt_username"  
							 class='input-block-level validate[required] smallFont' onkeydown="if(event.keyCode==13){submitLogin();}"/>
					</div>
				</div>
				<!-- <div class="control-group">
					<div class="pw controls">
						<label for="txt_password" style="margin-top: 50px;">رمز عبور:</label>
						<input type="password" style="direction:ltr;" name="" id="txt_password" placeholder="رمز عبور" 
							class="input-block-level validate[required] smallFont" onkeydown="if(event.keyCode==13){submitLogin();}"/>
				...
				<%-- <div class="control-group">
					<div class="controls">
						...
						<div class="input-block-level" style="width: 100%;margin-bottom:15px;">
							<select name="type" id="select_type" class="select2-me input-block-level select2-offscreen validate[required] smallFont" 
								data-placeholder="لطفا یک گزینه را انتخاب نمایید" tabindex="-1" onkeydown="if(event.keyCode==13){submitLogin();}">
				...
				<div class="submit">
					<button class="btn btn-primary smallFont" style="width:100%;line-height:25px;" onclick="submitLogin();" 
						onkeydown="if(event.keyCode==13){submitLogin();}" ><i class="icon-ok"></i> تایید</button>
					<!-- <input type="button" value="صفحه اصلی" style="float:right;background:#C2C2C2;" 
						class='btn btn-lightgrey smallFont' onclick="window.location.href='index.jsp'" /> -->
			...
			<div class="forget" style="margin-top: 10px;">
				<a href="login.jsp" style=""><span>ورود به سامانه</span></a>
			</div>
		</div>
