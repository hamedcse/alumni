...
@ResultPath(value="/")
public class LoadCollegesForAdminAction  extends ActionSupport  {
	private static final long serialVersionUID = 1L;
	private Collection<College> colleges = new ArrayList<College>();
	@Action(value="loadCollegesForAdmin", results={
		@Result(name="success", location="result/admin/manage_colleges/colleges.jsp"),
		@Result(name="error", location="result/admin/manage_colleges/colleges.jsp")
	})
