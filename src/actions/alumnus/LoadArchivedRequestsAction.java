...
@ResultPath(value="/")
public class LoadArchivedRequestsAction  extends ActionSupport  {
	private static final long serialVersionUID = 1L;
	private Collection<ArchivedRequest> requests = new ArrayList<ArchivedRequest>();
	@SuppressWarnings("rawtypes")
	@Action(value="loadArchivedRequests", results={
		@Result(name="success", location="result/alumnus/requests/archived_requests.jsp"),
	...
	public String execute(){
		...
		try {
			...
			requests = alumnus.getArchivedRequests().values();
