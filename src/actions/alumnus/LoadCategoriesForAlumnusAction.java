...
@ResultPath(value="/")
public class LoadCategoriesForAlumnusAction  extends ActionSupport  {
	private static final long serialVersionUID = 1L;
	private Collection<Category> categories = new ArrayList<Category>();
	@Action(value="loadCategoriesForAlumnus", results={
		@Result(name="success", location="result/alumnus/categories/categories.jsp"),
		@Result(name="error", location="result/alumnus/categories/not_found_category.jsp")
	})
