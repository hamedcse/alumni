...
@ResultPath(value="/")
public class LoadRecivedRequestsAction  extends ActionSupport  {
	private static final long serialVersionUID = 1L;
	private Collection<Request> requests = new ArrayList<Request>();
	@SuppressWarnings("rawtypes")
	@Action(value="loadRecivedRequests", results={
		@Result(name="success", location="result/alumnus/requests/recived_requests.jsp"),
	...
	public String execute(){
		...
		try {
			...
			alumnus.getRecivedRequests().values().size();
			requests = alumnus.getRecivedRequests().values();
