...
@ResultPath(value="/")
public class LoadSentMessagesAction  extends ActionSupport  {
	private static final long serialVersionUID = 1L;
	private Collection<SentMessage> messages = new ArrayList<SentMessage>();
	@SuppressWarnings("rawtypes")
	@Action(value="loadSentMessages", results={
		@Result(name="success", location="result/alumnus/messages/sent_messages.jsp"),
	...
	public String execute(){
		...
		try {
			...
			alumnus.getSentbox().values().size();
			messages = alumnus.getSentbox().values();
	...
	public Collection<SentMessage> getMessages() {
		return messages;
	}
	public void setMessages(Collection<SentMessage> messages) {
